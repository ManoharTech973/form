...
<div class="col-md-4 offset-md-4 mt-3">
	...
	<label>Student Name</label>				
	 	 <input type="text" onchange="validationForm()" value="<?php echo set_value('student_name');?>" class="form-control" name="student_name" id="student_name" />
...
<div class="form-group">
   ...
   <label>Student Email</label>
      <input type="text" onchange="validationForm()" value="<?php echo set_value('student_email')?>" class="form-control" name="student_email" id="student_email" />
...
<label>Student Mobile</label>
      <input type="text" onchange="validationForm()" value="<?php echo set_value('student_mobile')?>" class="form-control" name="student_mobile" id="student_mobile" />
...
<label>Gender</label>
  ...
  <input class="form-check-input" onchange="validationForm()" type="radio" value="male" name="gender" id="gender" <?php echo set_radio('gender','male'); ?> />
...
<div class="form-check">
  <input class="form-check-input" onchange="validationForm()" type="radio" value="female" name="gender" id="gender1" <?php echo set_radio('gender','female'); ?>/>
      ...
      <select name="course_name" onchange="validationForm()" id="course_name" class="form-control select2class">
        ...
        <?php if($courses){
          foreach($courses as $course){
            ?>
            <option <?php echo set_select('course_name',$course['course_id']); ?> value="<?php echo $course['course_id']; ?>"><?php echo $course['course_name']; ?></option>
            <?php
          }
        } ?>
